...
noise_covariance_slider = Slider(title="Шум (дисперсія)", value=INIT_NOISE_DISPERSION, start=0.01, end=1.0, step=0.01, **noise_slider_styles)
...
def reset():
    ...
    noise_covariance_slider.value = INIT_NOISE_DISPERSION
